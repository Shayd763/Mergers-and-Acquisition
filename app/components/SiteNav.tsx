  ...
  return (
    ...
    >
      <motion.button
        ...
        aria-haspopup="true"
        aria-expanded={open}
        style={{ display: "inline-flex", alignItems: "center", gap: 4, padding: "6px 13px", borderRadius: 9999, fontSize: 13, color: open ? "#1c1917" : "#78716c", fontWeight: 500, cursor: "pointer", background: "none", border: "none" }}
      >
        Calculators
      ...
      <div style={{ position: "fixed", top: 16, left: 0, right: 0, zIndex: 100, display: "flex", justifyContent: "center", padding: "0 12px", pointerEvents: "none", overflow: "hidden" }}>
        ...
        >
          ...
          <button
            ...
            style={{ marginLeft: 6, width: 44, height: 44, borderRadius: 10, border: "1px solid #d6d3d1", background: mobileNavOpen ? "#1c1917" : "#faf9f7", cursor: "pointer", display: "flex", flexDirection: "column", gap: 4, alignItems: "center", justifyContent: "center", transition: "background 0.2s", flexShrink: 0 }}
          >
