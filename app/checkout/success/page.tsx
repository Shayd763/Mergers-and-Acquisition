  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: 24, fontWeight: 800, color: "#0f172a", margin: "0 0 10px", letterSpacing: "-0.03em" }}>
          You&apos;re live!
        </h1>
        <p style={{ fontSize: 14, color: "#64748b", margin: "0 0 32px", lineHeight: 1.65 }}>
      ...
      <p style={{ fontSize: 12, color: "#94a3b8", marginTop: 24, textAlign: "center" }}>
        ...
        <a href="mailto:hello@triagefinance.co.uk" style={{ color: "#64748b" }}>hello@triagefinance.co.uk</a>
      </p>
    </div>
  );
}
