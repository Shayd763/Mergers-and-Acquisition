    ...
    <div style={{ background: "#0f172a", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, overflow: "hidden" }}>
      ...
      <div style={{ padding: "24px 24px 20px" }}>
        ...
        <div style={{ height: 10, borderRadius: 9999, overflow: "hidden", display: "flex", background: "#1e293b", marginBottom: 24, border: "1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ width: `${equity}%`, background: "linear-gradient(90deg,#6366f1,#818cf8)", transition: "width 0.15s" }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 700, color: "#6366f1", letterSpacing: "0.09em", textTransform: "uppercase" }}>UK M&A Market Conditions · {cd.displayName}</span>
              </div>
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
              ...
              <p style={{ fontSize: 12, fontWeight: 700, color: "#6366f1", letterSpacing: "0.09em", textTransform: "uppercase", marginBottom: 20 }}>Market Benchmarks · {cd.displayName} {sd.displayName}</p>
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
                ...
                <p style={{ fontSize: 12, fontWeight: 700, color: "#6366f1", letterSpacing: "0.09em", textTransform: "uppercase", margin: 0 }}>Active Businesses · Companies House · {cd.displayName}</p>
              </div>
